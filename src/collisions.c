...
static bool col_check_c2c(obj_t *obj1, obj_t *obj2, col_details_2d* o_details) {
    // radial check
...
static bool col_check_r2r(obj_t *obj1, obj_t *obj2, col_details_2d* o_details) {
...
static bool col_check_c2r(obj_t *c_obj, obj_t *r_obj, col_details_2d* o_details) {
    // convert all screencords
...
bool col_check_bbox(obj_t *obj1, obj_t *obj2, col_details_2d* o_details) {
    ...
    if(bt1 == CIRCLE && bt2 == CIRCLE) {
        colliding = col_check_c2c(obj1, obj2, o_details);
    } else if(bt1 == RECTANGLE && bt2 == RECTANGLE) {
        colliding = col_check_r2r(obj1, obj2, o_details);
    } else {
        obj_t *c_obj;
        obj_t *r_obj;
        ...
        colliding = col_check_c2r(c_obj, r_obj, o_details);
    }
